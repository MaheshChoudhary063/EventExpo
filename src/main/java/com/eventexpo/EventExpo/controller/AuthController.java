...
import com.eventexpo.EventExpo.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<User> addNewUser(@RequestBody User platformUser) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.saveUser(platformUser));
    }

    @PostMapping("/login")
    public ResponseEntity<String> getToken(@RequestBody AuthRequest authRequestDTO) {
        try {
